  ...
  useFrame((_, delta: number) => {
    ...
    if (modeRef.current === "manual") {
      ...
      if (agentRef.current === null) {
        ...
        // More pronounced pulsing for listening
        targetIn = clamp01(0.5 + Math.sin(t * 4.0) * 0.45)
        targetOut = 0.45
      } else if (agentRef.current === "talking") {
        // More subtle pulsing for talking
        targetIn = clamp01(0.7 + Math.sin(t * 4.0) * 0.1)
        targetOut = clamp01(0.7 + Math.sin(t * 3.0) * 0.1)
      } else {
        // thinking or other states
